...
declare module layui {
    ...
    interface Table {
        ...
        reload(option: TableOption): any;
        reload(id: string, option: TableOption): any;
        on(event: string, callback: (obj: any) => any): void;
        set(option: TableOption): any;
    ...
    interface TreeOption {
        ...
        showLine?: boolean;
        text?: object;
        click?: (obj: TreeClickObject) => void;
        oncheck?: (obj: TreeCheckObject) => void;
        operte?: (obj: TreeOperateObject) => void;
    ...
    interface Tree {
        render(option: TreeOption): Tree;
        checkData(id: string | number): TreeCheckObject;
        setChecked(treeId: string, nodeId: string | number): void;
        setChecked(treeId: string, nodeId: string[] | number[]): void;
        reload(id: string): Tree;
    }
    ...
    interface Flow {
        load(option: FlowOption): any;
        lazyimg(): any;
        lazyimg(option: FlowOption): any;
    }
    ...
    interface Util {
        fixbar(option: UtilBarOption): any;
        countdown(endtime: number | Date, serverTime: number | Date, callback: (date: any, serverTime: number | Date, timer: any) => void): any;
    ...
    interface Slider {
        ...
        setValue(value1: number, value2: number): any;
    }
